               ...
               <div class="row">
                  ...
                  <div class="col-lg-4 col-md-6">
                     <div class="checkout__order">
                        ...
                        <ul>
                           <li>로얄캐닌 인도어 <span>125,000원</span></li>
                           <li>로얄캐닌 키튼 <span>59,900원</span></li>
                           <li>로얄캐닌 라이트 웨이트 케어 <span>105,000원</span></li>
                        </ul>
                        <div class="checkout__order__total">
                           결제 예상 금액 <span>289,900원</span>
                        </div>
                        <div class="checkout__input__checkbox">
                           <input type="radio" name="pay" value="네이버페이"> 네이버페이 <br>
                           <br> <input type="radio" name="pay" value="신용카드">
                           신용카드 <br> <br> <input type="radio" name="pay"
                              value="휴대폰결제"> 휴대폰결제 <br> <br> <input
                              type="radio" name="pay" value="카카오페이"> 카카오페이 <br>
                           <br> <input type="radio" name="pay" value="무통장 입금">
                           무통장 입금 <br> <br>
                        </div>
